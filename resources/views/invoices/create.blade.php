...
@section('content')
	...
	<form action="{{ URL::to('invoice') }}" role="form" class="solsoForm" method="post">
		@csrf
		...
		<div class="col-md-3 col-lg-3">		
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" name="number" class="form-control required no-line" autocomplete="off" value="{{ $invoiceNumber ? $invoiceNumber : old('number') }}">
				</div>
		...
		<div class="col-md-3 col-lg-3">		
			<div class="form-group">
				...
				<input type="text" name="startDate" class="form-control datepicker required" autocomplete="off" value="{{ old('startDate') }}">
		...
		<div class="col-md-3 col-lg-3">		
			<div class="form-group">
				...
				<input type="text" name="endDate" class="form-control datepicker required" autocomplete="off" value="{{ old('endDate') }}">
		...
		<div class="col-md-12 col-lg-12">	
			...
			<tfoot>
				<tr>
					<td colspan="9">
						<button type="button" class="btn btn-primary btn-lg" id="createClone"><i class="fa fa-plus"></i> {{ trans('invoice.add') }}</button>
					</td>
				</tr>
				<tr>
					<td colspan="5">
						<div class="col-md-12 col-lg-3 form-inline">
							...
							<input type="text" name="invoiceDiscount" class="form-control solsoEvent" autocomplete="off">
                        ...
                        <div class="col-md-12 col-lg-6 form-inline">
							...
							<input type="text" name="revenue_stamp" class="form-control solsoEvent" autocomplete="off" value="0.500">
						</div>
					</td>
